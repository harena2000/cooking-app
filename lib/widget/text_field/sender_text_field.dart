...
class SenderTextField extends StatefulWidget {
  ...
  @override
  State<SenderTextField> createState() => _SenderTextFieldState();
}

class _SenderTextFieldState extends State<SenderTextField> {
